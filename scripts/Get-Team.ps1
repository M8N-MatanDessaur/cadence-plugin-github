<#
.SYNOPSIS
    Who works on a repository: commits, PRs, reviews asked, issues held, per person (30 days).
.EXAMPLE
    ./scripts/Get-Team.ps1 -Repo "MyRepo"
#>
[CmdletBinding()]
param(
...
Out-Json @((Get-Api "/api/github/team?repo=$(Esc $Repo)").people) 4
