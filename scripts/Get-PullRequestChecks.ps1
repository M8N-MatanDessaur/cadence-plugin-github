<#
.SYNOPSIS
    Checks and statuses on the head commit of a pull request.
.EXAMPLE
    ./scripts/Get-PullRequestChecks.ps1 -Repo "MyRepo" -Number 42
#>
[CmdletBinding()]
param(
...
Get-Api "/api/github/pulls/checks?repo=$(Esc $Repo)&number=$Number" | ConvertTo-Json -Depth 6
