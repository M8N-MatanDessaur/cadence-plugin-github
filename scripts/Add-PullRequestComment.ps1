<#
.SYNOPSIS
    Posts a comment on a pull request (Markdown; @mentions work).
.EXAMPLE
    ./scripts/Add-PullRequestComment.ps1 -Repo "MyRepo" -Number 42 -Body "Looks good, one question..."
#>
[CmdletBinding()]
param(
...
Post-Api '/api/github/pulls/comment' @{ repo = $Repo; number = $Number; body = $Body } | ConvertTo-Json
