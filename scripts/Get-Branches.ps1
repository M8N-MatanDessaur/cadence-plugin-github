<#
.SYNOPSIS
    Branches on GitHub, the default branch, the local branch and whether it is pushed.
.EXAMPLE
    ./scripts/Get-Branches.ps1 -Repo "MyRepo"
#>
[CmdletBinding()]
param(
...
Get-Api "/api/github/branches?repo=$(Esc $Repo)" | ConvertTo-Json -Depth 4
