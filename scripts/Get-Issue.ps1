<#
.SYNOPSIS
    One issue: body, comments, linked pull requests, history.
.EXAMPLE
    ./scripts/Get-Issue.ps1 -Repo "MyRepo" -Number 17
#>
[CmdletBinding()]
param(
...
Get-Api "/api/github/issues/detail?repo=$(Esc $Repo)&number=$Number" | ConvertTo-Json -Depth 8
