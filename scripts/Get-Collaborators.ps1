<#
.SYNOPSIS
    The collaborators of a repository (who can be assigned or asked to review).
.EXAMPLE
    ./scripts/Get-Collaborators.ps1 -Repo "MyRepo"
#>
[CmdletBinding()]
param(
...
Out-Json @((Get-Api "/api/github/collaborators?repo=$(Esc $Repo)").people) 6
