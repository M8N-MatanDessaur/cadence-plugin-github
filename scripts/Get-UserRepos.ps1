<#
.SYNOPSIS
    Repositories the token can see on GitHub, optionally filtered.
.EXAMPLE
    ./scripts/Get-UserRepos.ps1 -Query cadence
#>
[CmdletBinding()]
param(
    [string]$Query = '',
...
Get-Api "/api/github/user-repos?page=$Page&q=$(Esc $Query)" | ConvertTo-Json -Depth 4
