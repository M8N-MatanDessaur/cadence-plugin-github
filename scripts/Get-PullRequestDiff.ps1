<#
.SYNOPSIS
    The unified diff of one pull request, as text.
.EXAMPLE
    ./scripts/Get-PullRequestDiff.ps1 -Repo "MyRepo" -Number 42
#>
[CmdletBinding()]
param(
...
(Get-Api "/api/github/pulls/diff?repo=$(Esc $Repo)&number=$Number&cap=$Cap").diff
